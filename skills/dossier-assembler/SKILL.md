...
description: Once the firm profile, portco compilation, portco profiles, financial estimates for portcos, source ratings, and confidence scores have been produced, assemble the dossier according to dossier-structure.md. DO NOT include or make a list or table of the portfolio companies. DO NOT include any section about
...
A markdown document covering sections 1 through 4 of the dossier template, structured per the current template, with:
...
- Any subsection with no supporting source is ommitied silently.
...
- Section 4, "Review of Flagged and Satisfactory Content and Claims," is left as a placeholder heading only, with body text "*Pending audit-pass.*" dossier-assembler does not write section 4's content. That belongs to audit-pass, which runs after assembly and fills it in as the final step.
